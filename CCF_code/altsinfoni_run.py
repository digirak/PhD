...
im_pc=s.preProcessAltPCASINFONI(n_comps=n_comps,window_size=window_size,polyorder=order)
...
np.save("../Results_CCF/altsnrmatrix_for_%s_framesize_%d_PCs_%d_wmin_%1.1f_wmax_%1.1f_Teff_%d_logg_%3.2f.npy"%(fname,frame_size,n_comps,wmin_max[0],wmin_max[1],int(Teff),float(logg)),snrmatrix)
