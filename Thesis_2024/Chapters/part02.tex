...
The characterization hypothesis is ve`rified when a change in template produces a change in the error bars computed using the characterization matrix.


\textcolor{magenta}{describe characterization matrix here. Not done because left over from earlier thesis org.}
...
%The ability to produce this characterization matrix relies on sufficient evidence that the algorithm is indeed sensitive to changing templates.
% In subsequent sections, we will apply this benchmark to both ML and non-ML algorithms and discuss the results obtained.
